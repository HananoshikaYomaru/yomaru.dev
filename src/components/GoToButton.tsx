...
const GoToButton = ({ text, href, direction = "right" }: Props) => {
  return (
    <Link href={href}>
      ...
      >
        <>
          <p className="text-xl font-medium whitespace-nowrap ">{text}</p>
          <div className="relative h-8 w-8 md:h-14 md:w-14 flex items-center justify-center p-1 border rounded-full">
            {direction == "right" ? (
